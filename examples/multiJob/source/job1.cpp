...
void job1(HiCR::backend::host::L1::ComputeManager *computeManager, taskr::Runtime &taskr)
{
  ...
  auto taskAfc = computeManager->createExecutionUnit([]() { printf("Job 1 - Task A %lu\n", taskr::getCurrentTask()->getLabel()); });
  auto taskBfc = computeManager->createExecutionUnit([]() { printf("Job 1 - Task B %lu\n", taskr::getCurrentTask()->getLabel()); });
  auto taskCfc = computeManager->createExecutionUnit([]() { printf("Job 1 - Task C %lu\n", taskr::getCurrentTask()->getLabel()); });
