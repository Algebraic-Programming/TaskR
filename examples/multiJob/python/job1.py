...
def job1(runtime):
  ...
  taskAfc = taskr.Function(runtime, lambda task : print(f"Job 1 - Task A {task.getTaskId()}"))
  taskBfc = taskr.Function(runtime, lambda task : print(f"Job 1 - Task B {task.getTaskId()}"))
  taskCfc = taskr.Function(runtime, lambda task : print(f"Job 1 - Task C {task.getTaskId()}"))
